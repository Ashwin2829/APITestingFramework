...
public class ExtentListeners implements ITestListener,ISuiteListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		//testReport.get().fail("Test Case "+result.getStatus()+" "+result.getThrowable().getMessage().toString());
	...
	public void onFinish(ISuite suite) {
		...
		try {
			 messageBody = "http://"+InetAddress.getLocalHost().getHostAddress()+":8081/job/APITestingFramework/Extent_20Reports/"+fileName;
